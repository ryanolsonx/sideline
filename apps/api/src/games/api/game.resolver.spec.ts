...
describe('GameResolver', () => {
  ...
  it('resets the plan as the coach the request carries', async () => {
    const resetPlanForCoach = vi.fn().mockResolvedValue(liveView);
    const service = { resetPlanForCoach } as unknown as GameService;
