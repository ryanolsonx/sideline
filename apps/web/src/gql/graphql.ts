...
export type MarkAttendanceMutation = { __typename?: 'Mutation', markAttendance: (
    { __typename?: 'Game', id: string }
    & { ' $fragmentRefs'?: { 'GameSetupScreen_GameFragment': GameSetupScreen_GameFragment } }
  ) };

export type GameSetupScreen_GameFragment = { __typename?: 'Game', id: string, attendanceConfirmed: boolean, players: Array<{ __typename?: 'GamePlayer', id: string, name: string, present: boolean }> } & { ' $fragmentName'?: 'GameSetupScreen_GameFragment' };
